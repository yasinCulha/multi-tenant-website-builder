<nav class="navbar navbar-expand-lg kurumsal-navbar sticky-top">
    <div class="container">
        ...
        <button class="navbar-toggler border-0" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavLeft">
            <i class="fa-solid fa-bars fs-4 text-dark"></i>
        </button>
        <div class="collapse navbar-collapse justify-content-start" id="navbarNavLeft">
            <ul class="navbar-nav me-auto ms-lg-5 gap-2">
                <li class="nav-item">
