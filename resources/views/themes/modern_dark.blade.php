...
<body>
    ...
    <footer>
        <div class="container text-center">
            <p class="text-white-50 m-0 fw-semibold">&copy; 2026 {{ $company->name }}. Tüm Hakları Saklıdır.</p>
            <p class="small text-muted mt-2">Bu web sitesi <span class="text-indigo fw-bold" style="color: #6366f1;">TenantPanel</span> güvencesiyle otomatik olarak oluşturulmuştur.</p>
        </div>
    </footer>
